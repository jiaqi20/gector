...
class Seq2Labels(Model):
    ...
    def forward(self,  # type: ignore
        ...
        logits_labels = self.tag_projection_layer(self.predictor_dropout(encoded_text))
        ...
        log_likelihood = crf_label(logits_labels, labels, mask)
        log_likelihood_d = crf_label(logits_labels, labels, mask)

        output_dict["loss"] = -log_likelihood - log_likelihood_d
